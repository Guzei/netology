...
protocol Dealership {
    ...
    var cars: [Car] { get set } // массивы имеют только индексы и у одной и тойже машины в разных массивых индексы разные. Нужен надёжный ID для идентификации.
...
// сумел загнать в цикл и там сделать уже с проверками. Названия классов диллерских центров не кладутся.
